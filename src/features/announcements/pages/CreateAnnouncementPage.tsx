...
import { ArrowLeft, ChevronDown, Calendar as CalendarIcon, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
        ...
        <span className="text-slate-900">Create New Announcement</span>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="pt-4">
            <Button
              ...
              className="w-full h-12 bg-brand-primary hover:bg-brand-hover text-white rounded-xl font-semibold text-base shadow-lg shadow-blue-500/10 transition-all active:scale-[0.99]"
            >
